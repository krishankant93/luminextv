...
import heroImg from "../public/hd.webp";
...
const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2 ">
          <div className="max-w-2xl mb-3 sm:mb-8">
            ...
            Empowering Visions, Transforming Reality.
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            LuminexTV: Empowering Vision. Illuminating Entertainment. Unleash Brilliance. Welcome to Power.
            </p>
    ...
    <p className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">5 star rating | 200+ reviews</p>
</div>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link
                href="/contact"
                rel="noopener"
                className="px-4 py-2 sm:px-8 sm:py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md ">
               Contact Now
              </Link>
        ...
        <div className="flex items-center justify-center w-full -mt-3 md:mt-0 lg:w-1/2">
          <div className="">
          <motion.div
        animate={{
          y: [-10, 10],
